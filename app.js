...
app.use(function (req, res, next) {
  res.setHeader('Access-Control-Allow-Origin', 'http://https://play-bricks.vercel.app');
...
app.use(cors({
  origin: ["http://https://play-bricks.vercel.app"],
...
// Server listens on http://https://play-bricks.vercel.app
app.listen(5000);